...
export default function ReviewForm({ productId, onSuccess }: ReviewFormProps) {
    ...
    if (!isAuthenticated) {
        return (
            <div className="bg-gray-50 p-6 rounded-lg text-center">
                ...
                <a href="/login?redirect=back" className="text-primary font-bold underline">Login Here</a>
            </div>
        );
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
            ...
            <div className="mb-4">
                <label className="block text-xs font-bold uppercase tracking-wider text-secondary mb-2">Rating</label>
            ...
            <div className="mb-4">
                 <label className="block text-xs font-bold uppercase tracking-wider text-secondary mb-2">Comment</label>
                 <textarea
                    rows={3}
                    value={comment}
