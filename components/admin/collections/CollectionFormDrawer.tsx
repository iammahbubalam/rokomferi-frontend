          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-white sticky top-0 z-10">
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-medium mt-0.5">
                    {isCreating ? 'Create a curated edit' : `ID: ${collection.id}`}
                  </p>
                </div>
              ...
              <div className="flex-1 p-8 space-y-10">
                ...
                <section className="space-y-6">
                  ...
                  <div className="space-y-4">
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Collection Title</label>
                        <input
                            required
                ...
                {/* Narrative */}
                 <section className="space-y-6">
                  ...
                  <div className="space-y-4">
                     ...
                     <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Full Story (Rich Text)</label>
                        <textarea
                    ...
                    {formData.image ? (
                      <div className="relative w-full aspect-video mx-auto rounded-lg overflow-hidden shadow-md bg-white">
                        ...
                        <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                          <span className="text-white text-xs font-bold px-3 py-1.5 border border-white/50 rounded-full backdrop-blur-sm">Change Hero Image</span>
                        </div>
                      </div>
                    ) : (
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm font-bold text-gray-900">Upload Hero Image</p>
              ...
              <div className="px-8 py-6 border-t border-gray-100 bg-white flex items-center gap-4 sticky bottom-0 z-10">
                <Button type="button" variant="secondary" className="flex-1 py-3" onClick={onClose}>
                  Cancel
                </Button>
                <Button type="button" className="flex-[2] py-3" onClick={handleSubmit} disabled={isSubmitting}>
