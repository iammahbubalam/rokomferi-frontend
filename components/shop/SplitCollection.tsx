...
export function SplitCollection({ title, description, image, story, products }: SplitCollectionProps) {
  ...
  return (
    <div ref={containerRef} className="flex flex-col lg:flex-row min-h-screen relative">
          ...
          <div className="px-6 py-20 lg:px-20 lg:py-32 flex flex-col gap-24 lg:gap-32">
              ...
              {story && (
                  <div className="max-w-md">
                      <span className="text-secondary uppercase tracking-[0.2em] text-xs mb-4 block">Editorial</span>
              ...
              <div className="pt-20 border-t border-primary/10 flex justify-between items-end">
                   <div className="flex flex-col gap-2">
                       <span className="text-xs uppercase tracking-widest text-secondary">Next Collection</span>
                       <span className="font-serif text-2xl">Heritage 2024</span>
                   </div>
                   <button className="text-xs uppercase tracking-widest text-primary border-b border-primary pb-1">Discover</button>
              </div>
          </div>
      </div>
    </div>
