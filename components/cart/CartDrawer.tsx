        ...
        <>
          ...
          >
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-white z-10">
              <h2 className="font-serif text-2xl text-primary">Shopping Bag ({items.length})</h2>
              <button 
                onClick={toggleCart}
            ...
            {items.length > 0 && (
                <div className="px-6 py-4 bg-gray-50 border-b border-gray-100">
                    <p className="text-sm text-primary mb-2">
                        {remaining > 0 
                            ? <span>Spend <span className="font-bold">৳{remaining.toLocaleString()}</span> more for <span className="text-accent-gold font-medium">Free Shipping</span></span>
                            : <span className="text-green-700 font-medium">✨ You've unlocked Free Shipping!</span>
                        }
                    </p>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center space-y-4">
                  ...
                  <h3 className="font-serif text-xl text-primary">Your bag is empty</h3>
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-gray-50/50 space-y-4">
                <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm text-secondary">
                        <span>Shipping</span>
                        <span className="text-primary">{remaining <= 0 ? "Free" : "Calculated at checkout"}</span>
                    </div>
                </div>
