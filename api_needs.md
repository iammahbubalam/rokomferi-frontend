...
**Date:** 2026-01-11
**Context:** Rokomferi E-Commerce Platform

This document serves as the **definitive source of truth** for the backend API implementation. It details every endpoint required to power the `rokomferi-frontend` application.
