...
export const metadata = {
  title: "The Atelier | Rokomferi Editorial",
          ...
          <div className="md:col-span-5 relative">
            <div className="sticky top-32 p-8 bg-neutral-50 border border-neutral-100">
              ...
              <p className="text-neutral-600 font-light mb-8 leading-relaxed">
                A Rokomferi piece is designed to be an heirloom, passed down through generations, carrying with it the memories of the celebrations it witnessed.
              </p>
