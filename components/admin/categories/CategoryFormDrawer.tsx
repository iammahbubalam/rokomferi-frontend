          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="px-8 py-6 border-t border-gray-100 bg-white flex items-center gap-4 sticky bottom-0 z-10">
                <Button type="button" variant="secondary" className="flex-1 py-3 text-gray-600 bg-gray-100 hover:bg-gray-200 border-none relative top-0 hover:-top-0.5 transition-all" onClick={onClose}>
                  Cancel
                </Button>
