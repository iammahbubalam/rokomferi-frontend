...
export const CATEGORY_TREE: CategoryNode[] = [
  { id: "new", name: "New Arrivals", slug: "new-arrivals", children: [] },
  {
    id: "c1", name: "Women", slug: "women",
    children: [
      {
        id: "c1-1", name: "Ethnic Wear", slug: "ethnic-wear",
        children: [
      ...
      {
        id: "c1-2", name: "Fabrics", slug: "fabrics",
        children: [
  ...
  {
    id: "c2", name: "Collections", slug: "collections",
    children: [
...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    description: "In the stillness of the crescent moon, find the luxury of connection."
  },
  {
    id: 2,
    ...
    description: "Celebrate the hands that weave history. Authentic Katan, Muslin, and Silk."
  },
  {
    id: 3,
...
export const PHILOSOPHY_CONTENT: PhilosophyContent = {
  ...
  headline: { line1: "Celebration is found in", line2: "the details we share." },
  paragraphs: [
...
export const SITE_CONFIG: SiteConfig = {
  name: "Rokomferi",
  description: "Defining quiet luxury through texture, form, and timeless restraint.",
...
function mapBackendProductToFrontend(bp: BackendProduct): Product {
    const images = bp.media?.images || ["/assets/placeholder.png"];
    return {
        id: bp.id,
        name: bp.name,
        slug: bp.slug,
...
const MOCK_ORDERS: Order[] = [
  {
    ...
    timeline: [
      ...
      { status: "delivered", time: "2025-12-12T11:00:00Z", description: "Package delivered" }
    ]
  }
];
